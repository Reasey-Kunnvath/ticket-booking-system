...
<?php $__env->startSection('user_show', 'show'); ?>
<?php $__env->startSection('ul_active', 'active'); ?>
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">User Managerment</li>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <!-- Create User Modal -->
                <div class="modal fade" id="createUser" tabindex="-1" data-bs-backdrop="true">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="" enctype="multipart/form-data">
                                <div class="modal-body bg-light">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label for="inputName5" class="form-label">User ID</label>
                                            <input type="text" class="form-control" id="inputName5" disabled
                                                name="eventid" value="<?php echo e('G' . rand(1, 99999)); ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputName5" class="form-label">Full Name <code>*</code> </label>
                                            <input type="text" class="form-control" id="inputName5">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputEmail5" class="form-label">Email <code>*</code> </label>
                                            <input type="email" class="form-control" id="inputEmail5">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputPassword5" class="form-label">Phone Number
                                                <code>*</code></label>
                                            <input type="text" class="form-control" id="inputPassword5">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputPassword5" class="form-label">Birthday</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="eventImage" class="form-label">Upload Your Profile Image (JPG, JPEG,
                                                PNG)</label>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="viewEvent" tabindex="-1">
                                    <div class="modal-dialog modal-xl">5
                                        <div class="modal-content">
                                                        ...
                                                        <div class="col-xl-4">
                                                            <div class="card">
                                                                <div
                                                                    ...
                                                                    <img src="<?php echo e(asset('backend/assets/img/profile-img.jpg')); ?>"
                                                                    ...
                                                                    <div class="tab-content pt-2">
                                                                        ...
                                                                        <div class="tab-pane fade show active profile-overview"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-9 col-md-8">(+855)
                                                                                    12 990 101</div>
                                                                            </div>
                                                                            ...
                                                                            <p class="small fst-italic">Sunt est soluta
                                                                                ...
                                                                                unde veniam est qui dolor. Ut sunt iure
                                                                                rerum quae quisquam autem eveniet
                                                                        ...
                                                                        <div class="tab-pane fade profile-edit pt-3"
                                                                            ...
                                                                            <form>
                                                                                ...
                                                                                <div class="row mb-3">
                                                                                    <label for="dob"
                                                                                        class="col-mb-4 col-lg-3 col-form-label">Birthday</label>
                                                                                    <div class="col-md-8 col-lg-9">
                                                                                        <input name="dob"
                                                                                            type="text"
                                                                                            class="form-control"
                                                                                ...
                                                                                <div class="row mb-3">
                                                                                    <label for="about"
                                                                                        class="col-md-4 col-lg-3 col-form-label">Bio</label>
                                                                                    <div class="col-md-8 col-lg-9">
                                                                                        <textarea name="about" class="form-control" id="about" style="height: 100px">ABC
                                                                                        </textarea>
                                                                                    </div>
                                                                                </div>
...
<?php echo $__env->make('backend.layout.masterPage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Laravel\ticket-booking-system\resources\views/backend/userManagerment/UserList/index.blade.php ENDPATH**/ ?>