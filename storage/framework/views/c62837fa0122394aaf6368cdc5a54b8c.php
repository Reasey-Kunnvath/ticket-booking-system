...
<?php $__env->startSection('rp_active', 'active'); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#setpermission"><i class="bi bi-gear"></i></button>
                                <!-- Set Permission Modal -->
                                <div class="modal fade" id="setpermission" tabindex="-1">
                                            ...
                                            <div class="modal-body bg-light">
                                                <div class="col-lg-12 ">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="row mt-2">
                                                                <label class="col-sm-4 col-form-label">Old Role</label>
                                                                <div class="col-sm-8">
                                                             ...
                                                             <div class="row mt-2">
                                                                <label class="col-sm-4 col-form-label">Set New Role</label>
                                                                <div class="col-sm-8">
                                                                ...
                                                                <div class="card-body pt-3">
                                                                    ...
                                                                    <div class="tab-content pt-2">
                                                                        <div class="tab-pane fade show active profile-overview"
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-3 col-md-4 label">Permission
                                                                                </div>
                                                                                <div class="col-lg-9 col-md-8">
                                                                                    Guest</div>
                                                                            </div>
...
<?php echo $__env->make('backend.layout.masterPage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Laravel\ticket-booking-system\resources\views/backend/userManagerment/RolePermission/index.blade.php ENDPATH**/ ?>