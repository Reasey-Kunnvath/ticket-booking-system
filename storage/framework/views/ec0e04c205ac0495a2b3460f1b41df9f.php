          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <div class="d-flex justify-content-center py-4">
                <a href="<?php echo e(route('Home')); ?>" class="logo d-flex align-items-center w-auto" style="background-color: red">
                  <img src="<?php echo e(asset('frontend/assets/img/icon-deal.png')); ?>" alt="">
                  <span class="d-none d-lg-block">OG</span>
                </a>
              </div><!-- End Logo -->
...
<?php /**PATH D:\ST15\wamp\www\Ticket Booking System\ticket-booking-system\resources\views/backend/login.blade.php ENDPATH**/ ?>