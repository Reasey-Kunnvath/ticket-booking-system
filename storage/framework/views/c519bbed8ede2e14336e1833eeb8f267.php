<?php $__env->startSection('title', 'Ticket Manage View Detail '); ?>
<?php $__env->startSection('content'); ?>
<ul class="list-inline ">
  <li class="list-inline-item col-sm-11"><h1 >View Detail</h1></li>
  <li class="list-inline-item"><a href="<?php echo e(route('managerticket')); ?>" type="button" class="btn btn-primary" >Back</a></li>
</ul>
    <!-- End Page Title -->
...
<?php echo $__env->make('backend.layout.masterPage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Laravel\ticket-booking-system\resources\views/backend/ticketMng/manageTicketViewDetail.blade.php ENDPATH**/ ?>