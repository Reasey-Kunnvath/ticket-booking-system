    ...
    <div class="card overflow-hidden">
        <div class="row row-bordered row-border-primary">
            <div class="col-md-3 pt-0">
                ...
                <div class="list-group list-group-flush account-settings-links">
                    <a class="list-group-item text-danger" href="<?php echo e(url('/login')); ?>">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="your-order">
                        ...
                        <div class="card-body d-flex flex-column align-items-center justify-content-center" style="margin: 2rem;">
                            <img src="<?php echo e(asset("frontend/assets/img/image.png")); ?>" alt="" style="max-width: 50%; height: auto;" />
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ST15\wamp\www\Ticket Booking System\ticket-booking-system\resources\views/frontend/user_profile/user_profile_index.blade.php ENDPATH**/ ?>