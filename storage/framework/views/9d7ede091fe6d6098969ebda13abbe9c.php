        ...
        <div class="col">
            <div class="right-content">
                <div class="left-image">
                    <img src="<?php echo e(asset('frontend/assets/images/ticket-details.jpg')); ?>" alt=""/>
                  </div><br>
...
<script>
    document.getElementById('showAlert').addEventListener('click', function(event) {
        ...
        Swal.fire({
            ...
            html: 'Go to <a href="<?php echo e(url('/cart-checkout')); ?>" style="font-weight:bold; color: #3085d6; text-decoration: underline;">Cart</a> to Checkout',
            icon: "success"
        });
    });
</script>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ST15\wamp\www\Ticket Booking System\ticket-booking-system\resources\views/frontend/event_detail/event-detail.blade.php ENDPATH**/ ?>